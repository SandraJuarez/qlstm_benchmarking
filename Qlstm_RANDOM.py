...
class QLSTM(nn.Module):
    ...
    def circuit_forget(self,inputs,weights):
        ...
        def _circuit_forget(inputs, weights):
            ...
            qml.templates.RandomLayers(pesos, wires=wires_forget,ratio_imprim=0.5)
    ...
    def circuit_input(self,inputs,weights):
        ...
        def _circuit_input(inputs, weights):
            ...
            pesos=weights[0,:]
            pesos=pesos.reshape(1,-1)
            qml.templates.RandomLayers(pesos, wires=wires_input,ratio_imprim=0.5)
    ...
    def circuit_update(self,inputs,weights):
        ...
        def _circuit_update(inputs, weights):
            ...
            pesos=weights[0,:]
            pesos=pesos.reshape(1,-1)
            qml.templates.RandomLayers(pesos, wires=wires_update,ratio_imprim=0.5)
    ...
    def circuit_output(self,inputs,weights):
        ...
        def _circuit_output(inputs, weights):
            ...
            pesos=weights[0,:]
            pesos=pesos.reshape(1,-1)
            qml.templates.RandomLayers(pesos, wires=wires_output,ratio_imprim=0.5)
