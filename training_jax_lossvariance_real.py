...
os.environ["AWS_ROLE"] = "arn:aws:iam::054037109336:role/bracketCustomRole"
...
def train_model(X_train,Y_train,X_test,Y_test,trainloader,testloader,original_dataset,run_name,dataset, seq_len,n_layers,n_qubits,concat_size,target_size,key):
    ...
    model = QLSTM(n_qubits=3)
    dummy_input = jnp.ones(3)
    params = model.init(key, dummy_input)
    result = model.apply(params, dummy_input)
    print(result)
    '''
